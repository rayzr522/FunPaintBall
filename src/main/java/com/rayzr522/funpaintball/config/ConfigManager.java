            ...
            try {
                ...
                if (Reflection.hasInterface(field.getType(), ISerializable.class)) {
                    ...
                    try {
                        ...
                        System.err.println(
                                "SerializationHandler '" + handler.getClass().getCanonicalName() + "' encountered an invalid type while trying to load data for field '" + field.getName() + "'");
                        e.printStackTrace();
                    } catch (Exception e) {
            ...
            try {
                ...
                if (Reflection.hasInterface(field.getType(), ISerializable.class)) {
                    ...
                    if (!map) {
                        ...
                        System.err.println("Expected a Map for field '" + field.getName() + "' in '" + clazz.getCanonicalName() + "', however an instance of '"
                                + data.get(field.getName()).getClass().getCanonicalName() + "' was found!");
                        return null;
