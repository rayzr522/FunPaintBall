 ...
 * <a href="https://bukkit.org/threads/auto-respawn-player.350463/">Bukkit thread</a>
 *
 */
...
public class Respawn {
    ...
    /**
     * Attempts to automatically respawn the player. This will not work if the static setup failed. You can tell if it
     * failed or not by the presence of {@code "Failed to load Respawn utility!"} in the console.
     * 
     * @param who the player
     * @throws ReflectiveOperationException If something failed with the reflection
     */
